    ...
    <>
      <div className="mb-3" style={{ display: "flex", justifyContent: "space-between",alignItems:"center" }}>
        ...
        <div style={{ display: "flex",alignItems:"center" }}>
            <HomeIcon /> - <h6 className="mb-0"> Miscellaneous - Notifications</h6>
        </div>
      ...
      <div className="card">
        ...
        <div className="main-body2">
          ...
          <div className="NotifyTable">
            ...
            <TableContainer component={Paper} style={{ boxShadow: "gray" , fontSize:'12px' }}>
              <Table sx={{ minWidth: 650 }} aria-label="simple table">
                ...
                <TableBody>
                  {expiredNotif?.map((row, index) => (
                    <TableRow
                      key={index}
                      sx={{ "&:last-child td, &:last-child th": { border: 0 } ,fontSize:'12' }} style={{ fontSize:'12px' }}
                    >
