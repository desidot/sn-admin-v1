...
const EditSuppliers = () => {
  ...
  useEffect(() => {
    const fetchBrandData = async () => {
      try {
        const response = await axios.get(`${APIBASE}admin/suppliers/${id}`);
  ...
  // Fetch supplier data using the supplier ID from props
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (supplierData.country) {
        formData.append("country", supplierData.country);
      }

      await axios.post(`${APIBASE}admin/suppliers/${id}`, formData, {
        headers: {
      ...
      toast.warn("Make sure Supplier name should not be Empty.", {
        position: "top-center",
        autoClose: 2000,
      });
    }
    ...
    <>
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <div style={{ display: "flex" }}>
          ...
          <h6 style={{ margin: "5px" }}>
            Product Manager - Products - Edit Suppliers
          </h6>
        </div>
            ...
            <Grid item xs={12} sm={6}>
              ...
              <div className="input-field">
                ...
                <FormControl fullWidth>
                  <select
                    style={{ border: "1px solid gray", height: "45px" ,width:"100%"}}
