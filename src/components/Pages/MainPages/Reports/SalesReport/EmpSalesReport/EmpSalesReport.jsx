...
const EmployeeSalesReport = () => {
  ...
  const allEmployees = useSelector((state) => state.cart.allEmployees);
    ...
    if (from_date && to_date && employee) {
      try {
        const res = await axios.get(
          `${APIBASE}admin/reports/get-employee-sales-report/${employee}/${from_date}/${to_date}`
        );
    ...
    <>
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <div style={{ display: "flex" }}>
          ...
          <h6 style={{ margin: "5px" }}>
            Report - Sales Report - POS - Employee Sales Report
          </h6>
        </div>
        ...
        <div className="filter-container">
          <Grid container spacing={2}>
            <Grid item xs={12} md={3}>
              <InputLabel htmlFor=""> All User :</InputLabel>
